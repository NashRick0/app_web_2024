...
//1.- Funciones que no reciben parametros y no regresan valores
function suma1(){
    let n1=2
    let n2=3
    let suma=n1+n2
...
//2.- Funciones que no reciben parametros y si regresan valores
function suma2(){
    let n1=2
    let n2=3
    let suma=n1+n2
...
//3.- Funciones que si reciben parametros y no regresan valores
...
//4.- Funciones que si reciben parametros y si regresan valores
...
let sum1=suma4(5,999);
datos.innerHTML+=`<hr><h2>La suma 2 es: ${sum1}</h2><hr>`;
